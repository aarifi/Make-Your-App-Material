...
public class ListResponsDataAbout implements Parcelable {
    ...
    protected ListResponsDataAbout(Parcel in) {
    ...
    public static final Creator<ListResponsDataAbout> CREATOR = new Creator<ListResponsDataAbout>() {
        @Override
        public ListResponsDataAbout createFromParcel(Parcel in) {
            return new ListResponsDataAbout(in);
        }

        @Override
        public ListResponsDataAbout[] newArray(int size) {
            return new ListResponsDataAbout[size];
        }
    };

    public ListResponsDataAbout() {
    }
